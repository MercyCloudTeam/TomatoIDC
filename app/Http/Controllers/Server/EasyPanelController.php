...
//        !$configure->access ? $configureUrl .= "&access=access.xml": $configureUrl .= "&access=" . $configure->access;
        !$configure->subdir_flag ?: $configureUrl .= "&subtemplete=" . $configure->mysql_verison;

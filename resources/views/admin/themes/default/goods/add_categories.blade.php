    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" id="add-form" action="{{url('/admin/good/categories/add')}}">
                        {{csrf_field()}}
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-alternative"
                                               placeholder="分组标题" value="{{old('title')}}" name="title">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subtitle" class="form-control form-control-alternative"
                                               value="{{old('subtitle')}}" placeholder="可为空">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <textarea rows="4" name="content" class="form-control form-control-alternative"
                                          placeholder="可为空">{{old('content')}}</textarea>
                            </div>
                        </div>

                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-username"
                                               ...
                                               name="name" value="{{old('name')?old('name'):Auth::user()->name}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-first-name"
                                               ...
                                               value="{{old('qq')?old('qq'):Auth::user()->qq}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <textarea rows="4" class="form-control form-control-alternative" name="signature"
                                          placeholder="座右铭">{{old('signature')?old('signature'):Auth::user()->signature}}</textarea>
                            </div>
                        </div>
